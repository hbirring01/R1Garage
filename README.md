...
### 📦 Latest release: [`v0.1.8`](https://github.com/hbirring01/R1Garage/releases/tag/v0.1.8) — 2026-05-27

[⬇️ Download `R1Garage-v0.1.8.apk`](https://github.com/hbirring01/R1Garage/releases/download/v0.1.8/R1Garage-v0.1.8.apk) · [Release notes](https://github.com/hbirring01/R1Garage/releases/tag/v0.1.8)

```
adb install R1Garage-v0.1.8.apk
```
<!-- LATEST_RELEASE:END -->
