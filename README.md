...
### 📦 Latest release: [`v0.1.7`](https://github.com/hbirring01/R1Garage/releases/tag/v0.1.7) — 2026-05-26

[⬇️ Download `R1Garage-v0.1.7.apk`](https://github.com/hbirring01/R1Garage/releases/download/v0.1.7/R1Garage-v0.1.7.apk) · [Release notes](https://github.com/hbirring01/R1Garage/releases/tag/v0.1.7)

```
adb install R1Garage-v0.1.7.apk
```
<!-- LATEST_RELEASE:END -->
