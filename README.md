...
### 📦 Latest release: [`v0.1.5`](https://github.com/hbirring01/R1Garage/releases/tag/v0.1.5) — 2026-05-26

[⬇️ Download `R1Garage-v0.1.5.apk`](https://github.com/hbirring01/R1Garage/releases/download/v0.1.5/R1Garage-v0.1.5.apk) · [Release notes](https://github.com/hbirring01/R1Garage/releases/tag/v0.1.5)

```
adb install R1Garage-v0.1.5.apk
```
<!-- LATEST_RELEASE:END -->
